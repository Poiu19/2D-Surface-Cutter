...
std::vector<Form*> FormSorter::sortByLengthWidth(std::vector<Form*> forms) //same as sortByLengthSize but faster
{
    for(unsigned int j = 0; j < forms.size()-1; j++)
        for(unsigned int i = 0; i < forms.size()-1; i++)
...
std::vector<Form*> FormSorter::sortByWidthLength(std::vector<Form*> forms) //same as sortByWidthSize but faster
{
    for(unsigned int j = 0; j < forms.size()-1; j++)
        for(unsigned int i = 0; i < forms.size()-1; i++)
